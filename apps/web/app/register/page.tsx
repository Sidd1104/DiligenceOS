    ...
    <AuroraBackground className="flex min-h-screen flex-col items-center justify-center p-4">
      ...
      <div className="w-full max-w-xl space-y-6">
        ...
        <div className="text-center space-y-2 flex flex-col items-center">
          <DiligenceLogo className="w-14 h-14 mb-1" textSize="text-3xl" />
          <p className="text-sm text-[#9a968c] max-w-sm mx-auto">
            Institutional due-diligence & evidence retrieval portal
          </p>
        </div>

        {/* Auth Card */}
        <div className="rounded-2xl border border-[rgba(245,243,239,0.08)] bg-[rgba(21,21,28,0.9)] p-10 shadow-2xl backdrop-blur-xl space-y-7">
          <div>
            <h2 className="text-xl font-semibold text-[#f5f3ef]">Create enterprise account</h2>
            <p className="text-sm text-[#9a968c] mt-1">Set up your analyst workspace account</p>
          </div>

          {error && (
            <div className="rounded-xl bg-[#ef4444]/10 p-4 text-sm text-[#ef4444] border border-[#ef4444]/20 flex items-center gap-2.5">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              <label htmlFor="fullName" className="block text-[12px] font-semibold text-[#9a968c] uppercase tracking-wider">
                Full Name (optional)
              </label>
              <div className="relative">
                <User className="absolute left-3.5 top-3.5 h-5 w-5 text-[#9a968c]" />
                <input
                  id="fullName"
                  type="text"
                  value={fullName}
            ...
            <div className="space-y-2">
              <label htmlFor="email" className="block text-[12px] font-semibold text-[#9a968c] uppercase tracking-wider">
                Work Email Address
              </label>
              <div className="relative">
            ...
            <div className="space-y-2">
              <label htmlFor="password" className="block text-[12px] font-semibold text-[#9a968c] uppercase tracking-wider">
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-3.5 top-3.5 text-[#9a968c] hover:text-[#f5f3ef] focus:outline-none transition-colors"
            ...
            <Button
              type="submit"
              className="w-full h-12 text-base font-medium rounded-xl shadow-md gap-2 mt-3"
